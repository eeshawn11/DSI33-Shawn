...
#         df_filtered_previous_year = df_merged.query("month.dt.year == @year-1")
# else:
#     if year == "All":
#         df_filtered = df_merged.query("town.str.contains(@town_option)")
#     else:
#         df_filtered = df_merged.query(
#             "month.dt.year == @year & town.str.contains(@town_option)"
#         )
#         df_filtered_previous_year = df_merged.query("month.dt.year == @year-1 & town.str.contains(@town_option)")
